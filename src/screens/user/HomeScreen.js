...
const styles = StyleSheet.create({
  ...
  location: { fontSize: 10, color: COLORS.mid },
  notifBtn: {
    width: 36,
    height: 36,
  ...
  notifPreviewTitle: { fontSize: 12, fontWeight: "900", color: COLORS.dark },
  notifPreviewMsg: { fontSize: 12, color: COLORS.mid, fontWeight: "600" },
  searchBar: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: COLORS.white,
  ...
  searchIcon: { fontSize: 15, color: COLORS.mid },
